      ...
      <div>
        <div className="w-full absolute py-8 text-center">
          ...
          <h2 className=" text-[2rem] text-[#00A082]">Loading</h2>
            <svg aria-hidden="true" class="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-300 fill-[#00A082]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
