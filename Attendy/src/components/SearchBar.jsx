...
const SearchBar = ({ onSearch }) => {
  ...
  <input 
    ...
    className="w-[760px] h-[50px] pl-12 pr-16 border-gray-300 rounded-3xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-bg-gray text-xl font-poppins"
  />
  <span className="absolute inset-y-0 right-9 flex items-center pr-4 pointer-events-none">
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 26 26" className="text-gray-500">
